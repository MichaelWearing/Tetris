...
public class LShape {
    ...
    private ArrayList<Piece> LShape;
    ...
    public LShape(TetrisGame tetrisGame) {
        this.LShape = new ArrayList<Piece>();
    ...
    public void createShape() {
        ...
        this.LShape.add(new Piece(256, 46, color));
        this.LShape.add(new Piece(256, 81, color));
        this.LShape.add(new Piece(221, 81, color));
        this.LShape.add(new Piece(186, 81, color));
        Collections.reverse(LShape);
    }

    public void rotateShapeClockwise() {
        Piece p0 = this.LShape.get(0);
        Piece p1 = this.LShape.get(1);
        Piece p2 = this.LShape.get(2);
        Piece p3 = this.LShape.get(3);
    ...
    public boolean checkForClockwiseRotation() {
        ...
        if (this.rotation == 1) {
            ...
            if (p2.getX() - blockSize < 46) {
                System.out.println("p3 second");
                return false;
            }

            if (p3.getX() - (blockSize * 2) < 46) {
                System.out.println("p3.5 second");
                return false;
            }
    ...
    public boolean checkForContactDown(Piece p) {
        ...
        for (Piece arrayP : this.game.shapesToBeDrawn()) {
            ...
            if (this.LShape.contains(arrayP)) {
                break;
            }
    ...
    public void moveLeft() {
        ...
        this.moveShape.moveLeft(LShape);
    }
    ...
    public void moveRight() {
        ...
        this.moveShape.moveRight(LShape);
    }
