...
public class SShape {
    ...
    private ArrayList<Piece> sShape;
    private Color color;
    ...
    public SShape(TetrisGame tetrisGame) {
        this.sShape = new ArrayList<Piece>();
    ...
    public void createShape() {
        ...
        this.sShape.add(new Piece(221, 46, color)); //3
        this.sShape.add(new Piece(186, 46, color)); //2 
        this.sShape.add(new Piece(186, 81, color)); //1
        this.sShape.add(new Piece(151, 81, color)); //0
        Collections.reverse(sShape);
    }

    public void rotateShapeClockwise() {
        Piece p0 = this.sShape.get(0);
        Piece p1 = this.sShape.get(1);
        Piece p2 = this.sShape.get(2);
        Piece p3 = this.sShape.get(3);
    ...
    public boolean checkForContactDown(Piece p) {
        ...
        for (Piece arrayP : this.game.shapesToBeDrawn()) {
            ...
            if (this.sShape.contains(arrayP)) {
                break;
            }
    ...
    public void moveLeft() {
       ...
       this.moveShape.moveLeft(sShape);
    }
    ...
    public void moveRight() {
       ...
       this.moveShape.moveRight(sShape);
    }
